...
public:
  constexpr patomic_unsigned_lock_free() noexcept = default;
...
public:
  constexpr patomic_signed_lock_free() noexcept = default;
...
EXPCL_DTOOL_DTOOLBASE void _patomic_notify_all(volatile uint32_t *value, uint32_t old);
#endif
